...
// Public GD client secret - not sensitive, same value in all GD clients.
// See https://wyliemaster.github.io/gddocs/#/topics/secrets
export const GD_CLIENT_SECRET = "Wmfd2893gb7";
